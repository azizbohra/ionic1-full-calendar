angular.module('ionicCalendarDisplay', [])
  ...
  .directive('myCalendar', function () {
    return {
      ...
      templateUrl: 'lib/angular/full-page-calendar/calendar.html',
      controller: ['$scope', '$filter', '$element', '$timeout', function ($scope, $filter, $element, $timeout) {

        // calculate height of each cell in calendar        
        // var a = angular.element($element[0].querySelector('.calendar_Date'))[0].clientWidth / 7;
        // $scope.col7Height = {
        //   height: a + "px"
        // };

        // var a = angular.element($element[0].querySelector('.calendar_Date'))[0].clientWidth / 4;
        // $scope.col4Height = {
        //   height: a + "px"
        // };
  ...
  .directive('modalCalendar', function () {
    return {
      ...
      templateUrl: 'lib/angular/full-page-calendar/calendar-modal.html',
      controller: ['$scope', '$filter', '$element', '$timeout', function ($scope, $filter, $element, $timeout) {
